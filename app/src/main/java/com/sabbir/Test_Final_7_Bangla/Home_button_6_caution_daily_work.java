 ...
 */
public class Home_button_6_caution_daily_work extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.home_button_6_caution_daily);
        //overridePendingTransition(R.anim.left_to, R.anim.right);



        //.....For button clicks.....
        final Button mButton1 = (Button) findViewById(R.id.bike);
        final Button mButton2 = (Button) findViewById(R.id.driving);
        final Button mButton3 = (Button) findViewById(R.id.pregnant);
        final Button mButton4 = (Button) findViewById(R.id.hot_weather);
        final Button mButton5 = (Button) findViewById(R.id.cold_weather);
