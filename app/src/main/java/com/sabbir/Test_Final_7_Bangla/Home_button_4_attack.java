 ...
 */
public class Home_button_4_attack extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.home_button_4_attack);
        //overridePendingTransition(R.anim.left_to, R.anim.right);



        //.....For button clicks.....
        final Button mButton1 = (Button) findViewById(R.id.snake);
        final Button mButton2 = (Button) findViewById(R.id.dog);
        final Button mButton3 = (Button) findViewById(R.id.insect);
        final Button mButton4 = (Button) findViewById(R.id.bee);
        //final Button mButton5 = (Button) findViewById(R.id.mosquito);
        ...
        mButton1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(), Home_button_4_attack_1_snake.class);
                startActivity(i);
        ...
        mButton2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                mButton4.setSelected(false);
                //mButton5.setSelected(false);
                Intent i = new Intent(view.getContext(), Home_button_4_attack_2_dog.class);
                startActivity(i);
                //overridePendingTransition(R.anim.right_to, R.anim.left);
            }
        });
        mButton3.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                mButton4.setSelected(false);
                //mButton5.setSelected(false);
                Intent i = new Intent(view.getContext(), Home_button_4_attack_3_insect.class);
                startActivity(i);
                //overridePendingTransition(R.anim.right_to, R.anim.left);
            }
        });
        mButton4.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                mButton3.setSelected(false);
                mButton1.setSelected(false);
                Intent i = new Intent(view.getContext(), Home_button_4_attack_4_bee.class);
                startActivity(i);
                //mButton5.setSelected(false);
                //overridePendingTransition(R.anim.right_to, R.anim.left);
            }
