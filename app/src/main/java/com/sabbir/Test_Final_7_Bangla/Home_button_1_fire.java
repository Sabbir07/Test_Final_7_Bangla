...
public class Home_button_1_fire extends AppCompatActivity implements View.OnClickListener{
    ...
    private boolean viewGroupIsNotVisible1 = true,
                    viewGroupIsNotVisible2 = true,
                    viewGroupIsNotVisible3 = true,
                    viewGroupIsNotVisible4 = true;

    @Override
    public void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.home_button_1_fire);
        //overridePendingTransition(R.anim.left_to, R.anim.right);



        //.....For button clicks.....
        final Button mButton1 = (Button) findViewById(R.id.button10);
        final Button mButton2 = (Button) findViewById(R.id.button11);
        final Button mButton3 = (Button) findViewById(R.id.button12);
        final Button mButton4 = (Button) findViewById(R.id.button13);
        final Button mButton5 = (Button) findViewById(R.id.button14);
        ...
        mButton2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                mButton4.setSelected(false);
                mButton5.setSelected(false);
                Intent i = new Intent(view.getContext(), Home_button_1_fire_2_home.class);
                startActivity(i);
                //overridePendingTransition(R.anim.right_to, R.anim.left);
            }
        });
        mButton3.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                mButton4.setSelected(false);
                mButton5.setSelected(false);
                Intent i = new Intent(view.getContext(), Home_button_1_fire_3_car.class);
                startActivity(i);
                //overridePendingTransition(R.anim.right_to, R.anim.left);
            }
        });
        mButton4.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                mButton1.setSelected(false);
                mButton5.setSelected(false);
                Intent i = new Intent(view.getContext(), Home_button_1_fire_4_wildfire.class);
                startActivity(i);
                //overridePendingTransition(R.anim.right_to, R.anim.left);
            }
        });
        mButton5.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                mButton4.setSelected(false);
                mButton1.setSelected(false);
                Intent i = new Intent(view.getContext(), Home_button_1_fire_5_kitchen.class);
                startActivity(i);
                //overridePendingTransition(R.anim.right_to, R.anim.left);
            }
        });
    ...
    public void onClick(View v) {
        ...
        {
            /*
            //.....Buttons click goes here.....
            case R.id.button10:
                //v.startAnimation(buttonClick);
                Intent i = new Intent(this, Home_button_1_fire_1_burnt.class);
                startActivity(i);
                overridePendingTransition(R.anim.right_to, R.anim.left);
                break;
            case R.id.button11:
            ...
            */
            ...
            case R.id.linear2:
                ...
                viewGroupIsNotVisible2 = !viewGroupIsNotVisible2;
                break;
            ...
            case R.id.linear3:
                ...
                viewGroupIsNotVisible3 = !viewGroupIsNotVisible3;
                break;
            ...
            case R.id.linear4:
                ...
                viewGroupIsNotVisible4 = !viewGroupIsNotVisible4;
                break;
