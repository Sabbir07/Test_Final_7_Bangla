...
/**
 * Created by Sabbir on 006  11 04 17  Apr.
 */
public class Home_button_7_common_disease extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.home_button_7_common_disease);
        //overridePendingTransition(R.anim.left_to, R.anim.right);



        //.....For button clicks.....
        final Button mButton1 = (Button) findViewById(R.id.cold);
        final Button mButton2 = (Button) findViewById(R.id.breathing_problem);
        final Button mButton3 = (Button) findViewById(R.id.vomit);
        final Button mButton4 = (Button) findViewById(R.id.tooth_pain);
        final Button mButton5 = (Button) findViewById(R.id.muscle_pain);
        final Button mButton6 = (Button) findViewById(R.id.stomach_ache);
        final Button mButton7 = (Button) findViewById(R.id.hiccough);
        final Button mButton8 = (Button) findViewById(R.id.flu);
        final Button mButton9 = (Button) findViewById(R.id.pimple);
        final Button mButton10 = (Button) findViewById(R.id.high_pressure);
        final Button mButton11 = (Button) findViewById(R.id.diabetic);
        final Button mButton12 = (Button) findViewById(R.id.hair_fall);
