 ...
 */
public class Home_button_3_eye extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.home_button_3_eye);
        //overridePendingTransition(R.anim.left_to, R.anim.right);



        //.....For button clicks.....
        final Button mButton1 = (Button) findViewById(R.id.object);
        final Button mButton2 = (Button) findViewById(R.id.itching);
        final Button mButton3 = (Button) findViewById(R.id.tear);
        final Button mButton4 = (Button) findViewById(R.id.hit);
        final Button mButton5 = (Button) findViewById(R.id.cut);
