 ...
 */
public class Home_button_8_fever extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.home_button_8_fever);
        //overridePendingTransition(R.anim.left_to, R.anim.right);



        //.....For button clicks.....
        final Button mButton1 = (Button) findViewById(R.id.fever);
        final Button mButton2 = (Button) findViewById(R.id.malaria);
        final Button mButton3 = (Button) findViewById(R.id.dengue);
        final Button mButton4 = (Button) findViewById(R.id.typhoid);
